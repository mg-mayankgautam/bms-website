export const EventsData2324 = [
    {
        ...
        class: 'event1',
        photos: [require('../assets/cpc.png'), require('../assets/cpc1.png')],
        ...
        mainImg: require('../assets/cpc1.png'),
        style: {}
    },
    {
        name: "Uddeshya 2.0",
        class: 'event2',
        photos: [require('../assets/uddeshya.png')],
        ...
        mainImg: require('../assets/uddeshya.png'),
        style: {}
    },
    {
        name: "BLOOM",
        class: 'event3',
        photos: [require('../assets/bloom.png')],
        description: `Team BMS organised a fundraiser-cum-talent event, Uddeshya 2.0. The sole aim of this event was to raise funds for donating in Bal Seva Sansthan and have a visit to the orphanage for a pre Diwali Celebration. This event featured many cultural performances such as  Group Dance, Natak, Shayari etc. with a considerable amount of funds raised, the event turned out to be a monumental success.`,
        mainImg: require('../assets/bloom.png'),
        style: {}
    },
    {
        name: "Aap Kaha Se Ho?",
        class: 'event4',
        photos: [require('../assets/aksh.png')],
        ...
        mainImg: require('../assets/aksh.png'),
        style: {}
    },
    {
        name: "Breathe In, Bliss Out",
        class: 'event5',
        photos: [require('../assets/bibo.png'), require('../assets/bibo1.png')],
        ...
        mainImg: require('../assets/bibo.png'),
        style: {}
    },
    {
        name: "Bvest",
        class: 'event6',
        photos: [require('../assets/bvest.png'), require('../assets/bibo1.png')],
        ...
        mainImg: require('../assets/bvest.png'),
        style: {}
    }
];
